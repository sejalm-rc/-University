...
const tracks = [
 ...
 "Big Data Analytics"
  ...
  {
    title: "Track 2",
    subtitle: "Cutting-edge Electronics and Next-Gen Communication Technologies",
    topics: [
  ...
  {
    title: "Track 3",
    subtitle: "Power Electronics, Smart Grids and Electric Vehicle Technologies",
    topics: [
  ...
  {
    title: "Track 4",
    subtitle: "Robotics, Automation, Renewable Energy and Sustainability Technologies",
    topics: [
